...
import com.trading.lambda.LiquidityFilter;
import com.trading.lambda.IVRatioFilter;
import com.trading.lambda.TermStructureFilter;
import com.trading.lambda.ExecutionSpreadFilter;
import com.trading.lambda.FilterResult;
...
public class StockFilterLambda implements RequestHandler<Map<String, Object>, String> {
    ...
    private Map<String, Object> evaluateStockRecommendation(String ticker, String scanDate, Context context) {
        try {
            ...
            // Add status after filter results to ensure it's not overwritten
    ...
    private int writeResultsToFilteredTable(String scanDate, List<Map<String, Object>> recommendationResults, Context context) {
        ...
        for (Map<String, Object> recommendation : recommendationResults) {
            ...
            context.getLogger().log("Processing recommendation for " + ticker);
            ...
            // Write all recommendations (they're already validated as approved)
            try {
